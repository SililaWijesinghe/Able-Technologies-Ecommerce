...
import { Diamond, ChevronRight, Wrench, Settings, CheckCircle2, ShieldCheck, Clock, ArrowRight, PenTool, Zap, Layers, Award } from 'lucide-react';
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Diamond, title: "High Precision", desc: "Advanced technology" },
