const fs = require('fs');
let content = fs.readFileSync('src/pages/admin/AddProduct.tsx', 'utf8');
...
// Find the start of the Product Models / Variants block
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  fs.writeFileSync('src/pages/admin/AddProduct.tsx', newContent);
